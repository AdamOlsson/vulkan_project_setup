...
private:
  ...
  void initWindow() {
    ...
    // provides the 'this' pointer to the framebufferResizeCallback
  ...
  void createLogicalDevice() {
    ...
    uint32_t index = 0;
    vkGetDeviceQueue(device, indices.graphicsFamily.value(), index,
                     &graphicsQueue);
    vkGetDeviceQueue(device, indices.presentFamily.value(), index,
                     &presentQueue);
  }
