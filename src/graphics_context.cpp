...
void GraphicsContext::recreateSwapChain(VkDevice &device) {
...
GraphicsContext::getRequiredExtensions(bool enableValidationLayers) {
...
VkInstance GraphicsContext::createInstance(bool enableValidationLayers) {
...
GraphicsContext::setupDebugMessenger(VkInstance &instance,
...
void GraphicsContext::DestroyDebugUtilsMessengerEXT(
...
VkResult GraphicsContext::CreateDebugUtilsMessengerEXT(
...
VkSurfaceKHR GraphicsContext::createSurface(VkInstance *instance,
                                            GLFWwindow *window) {
...
VkDevice GraphicsContext::createLogicalDevice(
...
VkRenderPass GraphicsContext::createRenderPass(VkDevice &device,
...
GraphicsContext::createDescriptorSetLayout(VkDevice &device) {
...
GraphicsContext::createImageViews(VkDevice &device,
...
VkSurfaceFormatKHR GraphicsContext::chooseSwapSurfaceFormat(
...
VkPresentModeKHR GraphicsContext::chooseSwapPresentMode(
...
VkExtent2D GraphicsContext::chooseSwapExtent(
...
GraphicsContext::createSwapChain(VkPhysicalDevice &physicalDevice,
                                 VkDevice &device) {
  SwapChainSupportDetails swapChainSupport =
      querySwapChainSupport(physicalDevice);
...
QueueFamilyIndices
GraphicsContext::findQueueFamilies(const VkPhysicalDevice &device) {
...
std::tuple<std::vector<VkSemaphore>, std::vector<VkSemaphore>,
           std::vector<VkFence>>
GraphicsContext::createSyncObjects(VkDevice &device, const int capacity) {
...
GraphicsContext::createCommandBuffers(VkDevice &device, const int capacity) {
...
VkCommandPool
GraphicsContext::createCommandPool(VkPhysicalDevice &physicalDevice,
                                   VkDevice &device) {
...
std::vector<VkFramebuffer> GraphicsContext::createFramebuffers(
    VkDevice &device, std::vector<VkImageView> &swapChainImageViews) {
...
void GraphicsContext::createBuffer(VkDevice &device, VkDeviceSize size,
...
void GraphicsContext::copyBuffer(VkDevice &device, VkBuffer srcBuffer,
...
GraphicsContext::createIndexBuffer(VkDevice &device,
                                   const std::vector<uint16_t> &indices) {
...
std::tuple<VkBuffer, VkDeviceMemory>
GraphicsContext::createVertexBuffer(VkDevice &device,
...
uint32_t GraphicsContext::findMemoryType(uint32_t typeFilter,
                                         VkMemoryPropertyFlags properties) {
...
std::tuple<std::vector<VkBuffer>, std::vector<VkDeviceMemory>,
           std::vector<void *>>
GraphicsContext::createUniformBuffers(VkDevice &device, const int capacity) {
  ...
  uniformBuffers.resize(capacity);
  uniformBuffersMemory.resize(capacity);
  uniformBuffersMapped.resize(capacity);
